    ...
    <nav className="sticky top-0 z-[100] w-full border-b border-gray-200/50 dark:border-gray-800/50 bg-white/70 dark:bg-gray-950/70 backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:flex items-center space-x-1">
          ...
          <Link
            href="/auth"
            className="ml-4 px-5 py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-bold shadow-lg shadow-indigo-600/20 hover:bg-indigo-700 transition-all hover:scale-[1.02] active:scale-95 flex items-center gap-2"
          >
            <span>Sign In</span>
            <User size={16} />
          </Link>
        ...
        <div className="lg:hidden border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-6 space-y-8 animate-in slide-in-from-top-4 duration-300">
          ...
          <div className="space-y-3 pt-4 border-t border-gray-100 dark:border-gray-900">
            ...
            <Link 
              href="/auth" 
              onClick={() => setIsMenuOpen(false)} 
              className="flex items-center space-x-3 p-4 rounded-2xl text-base font-bold text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/50 transition-all"
            >
